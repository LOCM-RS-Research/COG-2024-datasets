...
# ... Execute using bash script ...

test_decks_results <- aggregate_test_data("logs/test_decks.txt", "logs/test_log.njson", "logs/test_decks_results.csv")
...
rownames(cardlist_2) <- NULL # resette rownames
...
# dritter Versuch: Gegner spielen nur noch Kreaturen
...
test_decks_results_trend_rando <- aggregate_test_data("logs/test_decks.txt", "logs/test_log_trend_2_random.njson", "logs/test_decks_results_trend_2_random.csv")
...
# replace random cards by new cards
